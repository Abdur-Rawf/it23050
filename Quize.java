...
sc.nextLine();
System.out.println("Rule:You Have % question. For every correct ans, score is increase 5, for wrong ans 1 will decrease from Score");
System.out.print("Press Enter for Next");
sc.nextLine();
...
{
System.out.println("Wrong! Correct is B.Sunflower");
    score-=1;
    from+=5;
